...
export class Contract {
  ...
  check_key(
    ...
    return this.account.viewMethod({
  ...
  update_allowanceRaw(
    ...
    return this.account.callMethod({
      contractId: this.contractId,
      method: "update_allowance",
      args,
      gas: options?.gas,
  ...
  async close_contract(
    args: {} = {},
    options?: ChangeMethodOptions,
  ): Promise<void> {
    return providers.getTransactionLastResult(
      await this.close_contractRaw(args, options),
    )
  }
  close_contractRaw(
    args: {} = {},
  ...
  async add_whitelist_account_ungaurded(
    args: {
      account_id: AccountId
      allowance: number
    },
    ...
    return providers.getTransactionLastResult(
      await this.add_whitelist_account_ungaurdedRaw(args, options),
    )
  }
  add_whitelist_account_ungaurdedRaw(
    args: {
      account_id: AccountId
      allowance: number
    },
    ...
    return this.account.callMethod({
      contractId: this.contractId,
      method: "add_whitelist_account_ungaurded",
      args,
      gas: options?.gas,
      deposit: options?.attachedDeposit,
    })
  }
  add_whitelist_account_ungaurdedTx(
    args: {
      account_id: AccountId
      allowance: number
    },
    ...
    return transactions.functionCall(
      "add_whitelist_account_ungaurded",
      args,
      options?.gas ?? DEFAULT_FUNCTION_CALL_GAS,
      options?.attachedDeposit ?? new BN(0),
    )
